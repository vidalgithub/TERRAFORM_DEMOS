  ...
  configmap_roles = [
    {
      ...
      rolearn = "${data.terraform_remote_state.eks.outputs.nodegroup_iam_role_arn}" #"${aws_iam_role.eks_nodegroup_role.arn}"
    ...
    },
    {
      ...
      # Important Note: The "subject" group name specified in clusterrolebinding and in aws-auth configmap "groups" should be same. 
