pipeline {
    agent {
        docker { 
            image 'vidaldocker/mastertf:kn1.0.3' 
                ...
                stage('APPLY') {
                    ...
                    steps {
                        script {
                            ...
                            withVault(configuration: [disableChildPoliciesOverride: false, timeout: 60, vaultCredentialId: 'vaultCred', vaultUrl: env.vaultUrl], vaultSecrets: [[path: 'mycreds/aws-creds/aj', secretValues: [[envVar: 'AWS_ACCESS_KEY_ID', vaultKey: 'AWS_ACCESS_KEY_ID'], [envVar: 'AWS_SECRET_ACCESS_KEY', vaultKey: 'AWS_SECRET_ACCESS_KEY']]]]) {
